...
const logInfo = (inputMessage, inputData) => {
  ...
  console.log(
    chalk.white.inverse.bold(` ${CURRENT_DATE_TIME} | INFO: ${inputMessage} `)
  );
...
const logSuccess = (inputMessage, inputData) => {
  ...
  console.log(
    chalk.green.inverse.bold(
      ` ${CURRENT_DATE_TIME} | SUCCESS: ${inputMessage} `
    )
  );
...
const logWarning = (inputMessage, inputData) => {
  ...
  console.log(
    chalk.yellow.inverse.bold(
      ` ${CURRENT_DATE_TIME} | WARNING: ${inputMessage} `
    )
  );
...
const logError = (inputMessage, inputError) => {
  ...
  // logging incoming message to the console
  console.log(
    chalk.red.inverse.bold(` ${CURRENT_DATE_TIME} | ERROR: ${inputMessage} `)
  );
